                ...
                <div className="border-t border-gray-200 bg-white px-4 py-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="inline-flex h-10 w-10 items-center justify-center rounded-lg btn-primary text-white disabled:opacity-60"
          ...
          <div className="w-full max-w-[364px] rounded-xl bg-white p-4 shadow-2xl">
            ...
            <div className="px-1 pb-1">
              ...
              <button
                ...
                className="mt-5 w-full rounded-lg btn-primary py-3 text-sm font-medium text-white disabled:opacity-60"
              >
