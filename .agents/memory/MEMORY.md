...
- [Rental Value Report](rental-value-report.md) — RentCast lead magnet (in-app copy + standalone zip share /api/estimate); leads → public.leads (source-segmented, server-only RLS).
